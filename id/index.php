<?php
    $meta_description = 'Aplikasi pembuat laporan kerja harian terbaik. Lakukan penilaian & evaluasi karyawan secara sistematis serta dapatkan biaya kerja setiap tugas dengan detail.';
    $meta_keyword = 'Nippo, alat pembuat laporan, aplikasi laporan harian, aplikasi laporan karyawan, laporan harian karyawan';

    $og_title = 'Nippo | Laporan & Evaluasi Kerja Harian Jadi Mudah';
    $og_url = 'https://nippo.id';
    $og_image = 'https://nippo.id/assets/img/ogp/ogp-index.jpg';
    $og_description = 'Nippo merupakan aplikasi pembuat laporan kerja harian terbaik. Lakukan penilaian & evaluasi karyawan melalui sajian data yang sistematis; Solusi optimalisasi biaya manajemen untuk kerja remote.';

    $page_title = 'Nippo | Aplikasi Pembuat Laporan & Evaluasi Kerja Harian Karyawan';

    $link_canonical = 'https://nippo.id/id/';
