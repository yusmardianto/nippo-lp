<?php
    $meta_description = 'Nippo dilengkapi dengan fitur manajemen karyawan, statistik proyek, evaluasi karyawan, project management, pengeluaran projek berdasarkan jam kerja & kolom komentar.';
    $meta_keyword = 'Fitur nippo, fitur evaluasi karyawan, manajemen karyawan, manajemen proyek';

    $og_title = 'Nippo | Fitur Lengkap Dan Detail';
    $og_url = 'https://nippo.id';
    $og_image = 'https://nippo.id/assets/img/ogp/ogp-features.jpg';
    $og_description = 'Nippo dilengkapi dengan fitur lengkap dan detail untuk manajemen karyawan, statistik proyek, evaluasi karyawan, manajemen proyek, pengeluaran proyek berdasarkan jam kerja & kolom komentar.';

    $page_title = 'Nippo | Fitur Lengkap';

    $link_canonical = 'https://nippo.id/id/features.php';
